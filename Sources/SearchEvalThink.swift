...
public class SearchEvalThink : Think {
    var zones: Zones? = nil
    ...
    public init(searcher: Search, zones: Zones, pnsLessThan: Int, searchDepth: Int, wPossibleMoves: [Double], wEdge: [Double], wFixedPieces: [Double], wOpenness: [Double], wBoardEvaluation: [Double]) {
    ...
    public func think(_ color: Pieces, board: BoardRepresentation, info: Info) -> Hand {
        ...
        if let bitBoardClass = board.boardMediator.getBoard() as? FastBitBoard {
