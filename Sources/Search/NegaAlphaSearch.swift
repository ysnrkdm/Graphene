...
open class NegaAlphaSearch : Search {
    var nodeCount = 0
    ...
    open func search(_ boardRepresentation: BoardRepresentation, forPlayer: Pieces, evaluator: Evaluator, depth: Int) -> SearchResult {
        nodeCount = 0
